...
sleep 3
docker exec -e VAULT_ADDR="http://127.0.0.1:8200" -e VAULT_TOKEN="root" vault-dev vault kv put secret/database/credentials username=admin password=supersecret
export VAULT_ADDR="http://127.0.0.1:8200"
